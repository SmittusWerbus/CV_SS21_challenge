...
% Second image
%I2 = imread(fullfile('images','Dubai','2020_12.jpg'));


%I2 = imread(fullfile('images','Frauenkirche','2015_08.jpg'));
%I2 = imresize(I2, 0.25);
% I2 = single(I2);
...
%I1 = adapthisteq(I1,'NumTiles',[10 10]);
%I2 = adapthisteq(I2,'NumTiles',[10 10]);
